...
/*                                                                          */
/****************************************************************************/
void I2CRegBitSet(unsigned int baseAddr, unsigned char regAddr, unsigned char bitMask)
{
    // 发送寄存器地址
    I2CData[0] = regAddr;
    I2CSendBlocking(baseAddr, 1);
...
/*                                                                          */
/****************************************************************************/
void I2CRegBitClr(unsigned int baseAddr, unsigned char regAddr, unsigned char bitMask)
{
    // 发送寄存器地址
    I2CData[0] = regAddr;
    I2CSendBlocking(baseAddr, 1);
